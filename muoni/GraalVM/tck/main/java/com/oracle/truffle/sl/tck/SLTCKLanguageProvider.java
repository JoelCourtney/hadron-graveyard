...
public class SLTCKLanguageProvider implements LanguageProvider {
    ...
    private static final String PATTERN_VALUE_FNC = "fn %s() {return %s;}";
    private static final String PATTERN_BIN_OP_FNC = "fn %s(a,b) {return a %s b;}";
    private static final String PATTERN_POST_OP_FNC = "fn %s(a) {a %s;}";
    ...
    public Value createIdentityFunction(Context context) {
        return eval(context, "fn id (a) {return a;}", "id");
    }

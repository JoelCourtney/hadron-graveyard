 ...
 * parent expects a long value and calls {@link HadronLongLiteralNode#executeLong}. In the generic case,
 * the primitive value is automatically boxed by Java.
 */
@NodeInfo(shortName = "const")
public final class HadronLongLiteralNode extends HadronExpressionNode {

    private final long value;

    public HadronLongLiteralNode(long value) {
        this.value = value;
    }

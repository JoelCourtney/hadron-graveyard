...
/**
 * Builtin function that reads a String from the {@link HadronContext#getInput() standard input}.
 */
@NodeInfo(shortName = "readln")
public abstract class HadronReadlnBuiltin extends HadronBuiltinNode {

    @Specialization
    public String readln(@CachedContext(HadronLanguage.class) HadronContext context) {
    ...
    private String doRead(BufferedReader in) {
        try {
            ...
            throw new HadronException(ex.getMessage(), this);
        }
    }
}

...
public abstract class HadronPrintBuiltin extends HadronBuiltinNode {

    @Specialization
    public long print(long value, @CachedContext(HadronLanguage.class) HadronContext context) {
    ...
    @Specialization
    public boolean print(boolean value, @CachedContext(HadronLanguage.class) HadronContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
    ...
    @Specialization
    public String print(String value, @CachedContext(HadronLanguage.class) HadronContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }
    ...
    @Specialization
    public Object print(Object value, @CachedContext(HadronLanguage.class) HadronContext context) {
        doPrint(context.getOutput(), value);
        return value;
    }

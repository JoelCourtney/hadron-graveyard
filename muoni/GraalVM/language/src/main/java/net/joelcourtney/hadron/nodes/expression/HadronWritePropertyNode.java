...
import net.joelcourtney.hadron.nodes.util.HadronToMemberNode;
...
@NodeChild("nameNode")
@NodeChild("valueNode")
public abstract class HadronWritePropertyNode extends HadronExpressionNode {
    ...
    protected Object write(Object receiver, Object index, Object value,
        ...
        try {
            ...
            throw HadronUndefinedNameException.undefinedProperty(this, index);
        }
        return value;
    }
    ...
    protected Object write(Object receiver, Object name, Object value,
                    ...
                    @Cached HadronToMemberNode asMember) {
        try {
            ...
            throw HadronUndefinedNameException.undefinedProperty(this, name);
        }
        return value;
    }

...
public final class HadronIfNode extends HadronStatementNode {

    /**
     * The condition of the {@code if}. This in a {@link HadronExpressionNode} because we require a
    ...
    /** Statement (or {@link HadronBlockNode block}) executed when the condition is true. */
    @Child private HadronStatementNode thenPartNode;

    /** Statement (or {@link HadronBlockNode block}) executed when the condition is false. */
    @Child private HadronStatementNode elsePartNode;
    ...
    public HadronIfNode(HadronExpressionNode conditionNode, HadronStatementNode thenPartNode, HadronStatementNode elsePartNode) {
    ...
    private boolean evaluateCondition(VirtualFrame frame) {
        try {
             ...
             * program.
             */
            throw HadronException.typeError(this, ex.getResult());
        }
    }
}

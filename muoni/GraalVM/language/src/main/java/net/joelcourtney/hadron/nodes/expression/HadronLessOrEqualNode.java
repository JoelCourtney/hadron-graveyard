...
/**
 * This class is similar to the {@link HadronLessThanNode}.
 */
@NodeInfo(shortName = "<=")
public abstract class HadronLessOrEqualNode extends HadronBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected boolean lessOrEqual(HadronBigNumber left, HadronBigNumber right) {

...
@NodeChild
public abstract class HadronUnboxNode extends HadronExpressionNode {
    ...
    @Specialization
    protected static HadronBigNumber fromBigNumber(HadronBigNumber value) {
        return value;
    }
    ...
    @Specialization
    protected static HadronFunction fromFunction(HadronFunction value) {
        return value;
    }

    @Specialization
    protected static HadronNull fromFunction(HadronNull value) {
        return value;
    }

 ...
 * variables {@link HadronNodeFactory#addFormalParameter in the method prologue}.
 */
public class HadronReadArgumentNode extends HadronExpressionNode {
    ...
    public HadronReadArgumentNode(int index) {
        this.index = index;
    }

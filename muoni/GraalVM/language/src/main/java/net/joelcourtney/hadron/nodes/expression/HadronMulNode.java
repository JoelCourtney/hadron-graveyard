 ...
 */
@NodeInfo(shortName = "*")
public abstract class HadronMulNode extends HadronBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected HadronBigNumber mul(HadronBigNumber left, HadronBigNumber right) {
        return new HadronBigNumber(left.getValue().multiply(right.getValue()));
    }

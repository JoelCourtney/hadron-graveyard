...
public final class HadronLogicalAndNode extends HadronShortCircuitNode {

    public HadronLogicalAndNode(HadronExpressionNode left, HadronExpressionNode right) {
        super(left, right);
    }

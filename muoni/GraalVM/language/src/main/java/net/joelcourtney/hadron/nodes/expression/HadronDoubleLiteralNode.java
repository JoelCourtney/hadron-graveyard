 ...
 * parent expects a long value and calls {@link HadronDoubleLiteralNode#executeLong}. In the generic case,
 * the primitive value is automatically boxed by Java.
 */
@NodeInfo(shortName = "const")
public final class HadronDoubleLiteralNode extends HadronExpressionNode {

    private final double value;

    public HadronDoubleLiteralNode(double value) {
        this.value = value;
    }

...
/**
 * This class is similar to the extensively documented {@link HadronAddNode}. The only difference: the
 * specialized methods return {@code boolean} instead of the input types.
 */
@NodeInfo(shortName = "<")
public abstract class HadronLessThanNode extends HadronBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected boolean lessThan(HadronBigNumber left, HadronBigNumber right) {

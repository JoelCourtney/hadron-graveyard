...
public abstract class HadronEvalBuiltin extends HadronBuiltinNode {
    ...
    public Object evalCached(String id, String code,
                    ...
                    @CachedContext(HadronLanguage.class) HadronContext context,
    ...
    public Object evalUncached(String id, String code, @CachedContext(HadronLanguage.class) HadronContext context) {
        return parse(id, code, context).call();
    }

    protected CallTarget parse(String id, String code, HadronContext context) {

...
import net.joelcourtney.hadron.nodes.HadronUndefinedFunctionRootNode;
 ...
 * <p>
 * The {@link #callTarget} can be {@code null}. To ensure that only one {@link HadronFunction} instance
 * per name exists, the {@link HadronFunctionRegistry} creates an instance also when performing name
 * lookup. A function that has been looked up, i.e., used, but not defined, has a call target that
 * encapsulates a {@link HadronUndefinedFunctionRootNode}.
 */
@ExportLibrary(InteropLibrary.class)
public final class HadronFunction implements TruffleObject {

    public static final int INLINE_CACHE_SIZE = 2;

    private static final TruffleLogger LOG = TruffleLogger.getLogger(HadronLanguage.ID, HadronFunction.class);
    ...
    protected HadronFunction(HadronLanguage language, String name) {
        this.name = name;
        this.callTarget = Truffle.getRuntime().createCallTarget(new HadronUndefinedFunctionRootNode(language, name));
    ...
    /**
     * {@link HadronFunction} instances are always visible as executable to other languages.
     */
    ...
    abstract static class Execute {
         ...
         * function is redefined, the call target maintained by the HadronFunction object is changed. To
         * avoid a check for that, we use an Assumption that is invalidated by the HadronFunction when
        ...
        protected static Object doDirect(HadronFunction function, Object[] arguments,
        ...
        protected static Object doIndirect(HadronFunction function, Object[] arguments,

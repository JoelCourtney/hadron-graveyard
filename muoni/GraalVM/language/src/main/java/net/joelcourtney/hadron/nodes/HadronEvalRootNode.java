 ...
 * </ul>
 */
public final class HadronEvalRootNode extends RootNode {
    ...
    public HadronEvalRootNode(HadronLanguage language, RootCallTarget rootFunction, Map<String, RootCallTarget> functions) {
    ...
    public Object execute(VirtualFrame frame) {
        ...
        if (mainCallNode == null) {
            ...
            for (int i = 0; i < arguments.length; i++) {
                arguments[i] = HadronContext.fromForeignValue(arguments[i]);
            }

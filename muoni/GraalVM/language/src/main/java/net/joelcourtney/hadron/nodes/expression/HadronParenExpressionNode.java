...
/**
 * A {@link HadronExpressionNode} that represents a parenthesized expression; it simply returns the
...
public class HadronParenExpressionNode extends HadronExpressionNode {

    @Child private HadronExpressionNode expression;

    public HadronParenExpressionNode(HadronExpressionNode expression) {

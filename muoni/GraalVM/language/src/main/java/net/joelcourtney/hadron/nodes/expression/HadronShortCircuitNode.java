 ...
 * expressed in using this base class for {@link HadronLogicalAndNode} and {@link HadronLogicalOrNode}.
 */
public abstract class HadronShortCircuitNode extends HadronExpressionNode {

    @Child private HadronExpressionNode left;
    @Child private HadronExpressionNode right;
    ...
    public HadronShortCircuitNode(HadronExpressionNode left, HadronExpressionNode right) {
        this.left = left;
        this.right = right;
    }
    ...
    public final boolean executeBoolean(VirtualFrame frame) {
        ...
        try {
            ...
            throw HadronException.typeError(this, e.getResult(), null);
        }
        boolean rightValue;
        try {
            ...
            throw HadronException.typeError(this, leftValue, e.getResult());
        }

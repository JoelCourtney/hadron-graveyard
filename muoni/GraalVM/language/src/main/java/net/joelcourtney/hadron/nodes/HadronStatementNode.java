 ...
 * local variables.
 */
@NodeInfo(language = "hadron", description = "The abstract base node for all SL statements")
@GenerateWrapper
@ReportPolymorphism
public abstract class HadronStatementNode extends Node implements InstrumentableNode {
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new HadronStatementNodeWrapper(this, probe);
    }

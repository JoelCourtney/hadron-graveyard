 ...
 * The builtin functions are registered in {@link HadronContext#installBuiltins}. Every builtin node
 * subclass is instantiated there, wrapped into a function, and added to the
 * {@link HadronFunctionRegistry}. This ensures that builtin functions can be called like user-defined
 * functions; there is no special function lookup or call node for builtin functions.
 */
@NodeChild(value = "arguments", type = HadronExpressionNode[].class)
@GenerateNodeFactory
public abstract class HadronBuiltinNode extends HadronExpressionNode {
    ...
    public final Object executeGeneric(VirtualFrame frame) {
        try {
            ...
            throw HadronException.typeError(e.getNode(), e.getSuppliedValues());
        }
    }

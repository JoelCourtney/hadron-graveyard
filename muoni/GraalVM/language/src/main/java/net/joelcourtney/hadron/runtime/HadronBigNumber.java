...
public final class HadronBigNumber implements TruffleObject, Comparable<HadronBigNumber> {
    ...
    public HadronBigNumber(BigInteger value) {
        this.value = value;
    }

    public HadronBigNumber(long value) {
    ...
    @TruffleBoundary
    public int compareTo(HadronBigNumber o) {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof HadronBigNumber) {
            return value.equals(((HadronBigNumber) obj).getValue());
        }
        return false;
    }

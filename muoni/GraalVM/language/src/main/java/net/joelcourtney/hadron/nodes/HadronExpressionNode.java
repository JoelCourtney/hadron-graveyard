...
@GenerateWrapper
public abstract class HadronExpressionNode extends HadronStatementNode {
    ...
    /**
     * When we use an expression at places where a {@link HadronStatementNode statement} is already
    ...
    public WrapperNode createWrapper(ProbeNode probe) {
        return new HadronExpressionNodeWrapper(this, probe);
    }
    ...
    public long executeLong(VirtualFrame frame) throws UnexpectedResultException {
        return HadronTypesGen.expectLong(executeGeneric(frame));
    }

    public double executeDouble(VirtualFrame frame) throws UnexpectedResultException {
        return HadronTypesGen.expectDouble(executeGeneric(frame));
    }

    public boolean executeBoolean(VirtualFrame frame) throws UnexpectedResultException {
        return HadronTypesGen.expectBoolean(executeGeneric(frame));
    }
}

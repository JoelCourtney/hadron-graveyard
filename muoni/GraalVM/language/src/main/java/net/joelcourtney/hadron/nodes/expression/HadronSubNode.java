 ...
 */
@NodeInfo(shortName = "-")
public abstract class HadronSubNode extends HadronBinaryNode {
    ...
    @Specialization
    @TruffleBoundary
    protected HadronBigNumber sub(HadronBigNumber left, HadronBigNumber right) {
        return new HadronBigNumber(left.getValue().subtract(right.getValue()));
    }

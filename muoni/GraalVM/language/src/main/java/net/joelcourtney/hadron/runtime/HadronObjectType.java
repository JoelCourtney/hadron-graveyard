...
public final class HadronObjectType extends ObjectType {

    protected static final int CACHE_LIMIT = 3;
    public static final ObjectType SINGLETON = new HadronObjectType();

    private HadronObjectType() {
    }

    @Override
    public Class<?> dispatch() {
        return HadronObjectType.class;
    }

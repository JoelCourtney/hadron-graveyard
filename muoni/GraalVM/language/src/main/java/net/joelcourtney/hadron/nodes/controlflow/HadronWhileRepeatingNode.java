 ...
 * SOFTWARE.
 */
package net.joelcourtney.hadron.nodes.controlflow;
...
/**
 * The loop body of a {@link HadronWhileNode while loop}. A Truffle framework {@link LoopNode} between
 * the {@link HadronWhileNode} and {@link HadronWhileRepeatingNode} allows Truffle to perform loop
 * optimizations, for example, compile just the loop body for long running loops.
 */
public final class HadronWhileRepeatingNode extends Node implements RepeatingNode {

    /**
     * The condition of the loop. This in a {@link HadronExpressionNode} because we require a result
     ...
     */
    @Child private HadronExpressionNode conditionNode;

    /** Statement (or {@link HadronBlockNode block}) executed as long as the condition is true. */
    @Child private HadronStatementNode bodyNode;
    ...
    public HadronWhileRepeatingNode(HadronExpressionNode conditionNode, HadronStatementNode bodyNode) {
        this.conditionNode = HadronUnboxNodeGen.create(conditionNode);
    ...
    public String toString() {
        return HadronStatementNode.formatSourceSection(this);
    }

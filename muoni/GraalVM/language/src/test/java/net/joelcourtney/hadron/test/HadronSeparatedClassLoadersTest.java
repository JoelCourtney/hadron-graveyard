...
public class HadronSeparatedClassLoadersTest {
    ...
    public void sdkAndTruffleLanguageAPIAndSLInSeparateClassLoaders() throws Exception {
        ...
        URL slURL = HadronLanguage.class.getProtectionDomain().getCodeSource().getLocation();
        ...
        Object lang = languages.get("hadron");
        assertNotNull("Hadron language found: " + languages, lang);
    }

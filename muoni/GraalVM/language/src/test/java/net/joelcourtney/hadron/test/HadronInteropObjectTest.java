...
public class HadronInteropObjectTest {
    ...
    public void testObject() {
        final Source src = Source.newBuilder("hadron", "fn main() {o = new(); o.a = 10; o.b = \"B\"; return o;}", "testObject.sl").buildLiteral();
    ...
    public void testNewForeign() {
        final Source src = Source.newBuilder("hadron", "fn getValue(type) {o = new(type); o.a = 10; return o.value;}", "testObject.sl").buildLiteral();
        context.eval(src);
        Value getValue = context.getBindings("hadron").getMember("getValue");

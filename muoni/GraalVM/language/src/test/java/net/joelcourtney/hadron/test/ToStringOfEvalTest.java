...
public class ToStringOfEvalTest {
    ...
    public void checkToStringOnAFunction() {
        context.eval("hadron", "fn checkName() {}");
        Value value1 = context.getBindings("hadron").getMember("checkName");
        Value value2 = context.getBindings("hadron").getMember("checkName");

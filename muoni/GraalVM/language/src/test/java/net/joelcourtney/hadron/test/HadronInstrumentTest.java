...
import static net.joelcourtney.hadron.test.HadronJavaInteropTest.toUnixString;
 ...
 */
public class HadronInstrumentTest {
    ...
    public void testLexicalScopes() throws Exception {
        String code = "fn test(n) {\n" +
                        ...
                        "  test(\"n_n\");\n" +
                        "}";
        Source source = Source.newBuilder("hadron", code, "testing").build();
    ...
    public void testRedoIO() throws Throwable {
        String code = "fn main() {\n" +
                        ...
                        "  return a;\n" +
                        "}\n";
        final Source ioWait = Source.newBuilder("hadron", code, "testing").build();
    ...
    public void testEarlyReturn() throws Exception {
        String code = "fn main() {\n" +
                        ...
                        "  return x + 1;\n" +
                        "}\n";
        final Source source = Source.newBuilder("hadron", code, "testing").build();
        ByteArrayOutputStream engineOut = new ByteArrayOutputStream();
        ...
        earlyReturn.returnValue = new HadronBigNumber(new BigInteger("-42"));
        ret = context.eval(source);
        assertTrue(ret.isNumber());
    ...
    public void testReplaceNodeReturnValue() throws Exception {
        String code = "fn main() {\n" +
                        ...
                        "}\n";
        final Source source = Source.newBuilder("hadron", code, "testing").build();
        SourceSection ss = DebuggerTester.getSourceImpl(source).createSection(24-6, 5);
    ...
    /**
     * Test that we can alter fn arguments on reenter.
     */
    @Test

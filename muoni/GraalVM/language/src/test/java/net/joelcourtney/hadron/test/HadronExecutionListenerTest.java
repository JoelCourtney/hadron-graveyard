...
public class HadronExecutionListenerTest {
    ...
    public void testFactorial() {
        ...
        String characters =
                        ...
                        "}";
        // @formatter:on
        context.eval("hadron", "fn " + characters);
        Value factorial = context.getBindings("hadron").getMember("fac");
    ...
    private Value eval(String s) {
        ...
        context.eval("hadron", wrapInFunction(s));
        return context.getBindings("hadron").getMember("wrapper").execute();
    }

    private static String wrapInFunction(String s) {
        return "fn " + rootSourceSection(s);
    }
